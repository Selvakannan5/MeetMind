...
import { register, login, googleLogin } from '../utils/api';
      ...
      <div className="w-full max-w-[440px] p-8 md:p-10 liquid-glass-card shadow-2xl space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center gap-3">
             <div className="w-10 h-10 bg-gradient-to-br from-[#6c63ff] to-[#00d4aa] rounded-bl-xl rounded-tr-xl flex items-center justify-center">
          ...
          <h2 className="text-[24px] font-bold tracking-tight text-white/90">
            Join the <span className="font-['Instrument_Serif'] italic font-normal text-[#5ed29c]">Future</span>
          </h2>
          <p className="text-[14px] text-white/50 font-['Inter']">
            Create an account to start mastering your meetings.
          </p>
        </div>

        {error && (
          <div className="bg-red-500/10 border border-red-500/20 text-red-400 px-4 py-3 rounded-lg text-[13px]">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#5ed29c] transition-colors" size={18} />
              <input
                type="text"
                required
                value={name}
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-bold text-white/40 uppercase tracking-widest ml-1">Secure Password</label>
            <div className="relative group">
        ...
        <div className="relative py-4">
          ...
          <div className="relative flex justify-center text-[11px] uppercase tracking-widest">
            <span className="bg-[#070b0a] px-4 text-white/30 backdrop-blur-sm rounded-full border border-white/5">Or join with</span>
          </div>
        </div>
        ...
        <p className="text-center text-[13px] text-white/40">
          Already a member? <Link to="/login" className="text-[#5ed29c] font-bold hover:underline">Sign in</Link>
        </p>
